...
TARGET		:=	MBI
BUILD		:=	build
SOURCES		:=	source source/ui source/data source/install source/nx source/util
DATA		:=	data
INCLUDES	:=	include include/ui include/data include/install include/nx include/util
APP_TITLE	:=	MBI
APP_AUTHOR	:=	R-YaTian
APP_VERSION	:=	1.0.0
ROMFS		:=	romfs
