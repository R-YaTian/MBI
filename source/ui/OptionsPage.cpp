...
namespace app::ui
{
    ...
    void OptionsPage::Use12hTimeOption_Click()
    {
        ...
        app::config::use12hTime = !app::config::use12hTime;
        use12hTimeOption->SetIcon(this->getMenuOptionIcon(app::config::use12hTime));
    }
    ...
    void OptionsPage::LanguageOption_Click()
    {
        ...
        s32 rc = app::facade::ShowDialog("options.language.title"_lang, "options.language.desc"_lang, languageStrings, false, "language");
